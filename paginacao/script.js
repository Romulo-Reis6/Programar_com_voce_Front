// Simulação de chamada para API (fetch)
    ...
    leftArrow.addEventListener('click', () => {
        ...
        const currentPageNumber = Number(document.querySelector('#page-number').value);
        itensNumber = Number(document.querySelector('#itens-number').value);
